...
export default function PruefenPage() {
  ...
  return (
    <div className="px-5 pt-5">
      ...
      <p className="text-[14px] text-ink-3 font-[650] mt-1">Art + Datum + Bundesland in 3 Sekunden</p>
      ...
      <div className="mt-6 bg-card border border-line rounded-[var(--r-lg)] p-[18px] shadow-[var(--shadow-s)]">
        ...
        <input
          ...
          className="w-full p-3 rounded-[var(--r-md)] border border-line bg-bg text-ink text-[15px] font-[680] mb-4"
        />
