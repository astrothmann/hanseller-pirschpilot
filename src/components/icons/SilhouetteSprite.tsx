  ...
  return (
    <svg width="0" height="0" style={{ position: "absolute" }} aria-hidden="true">
      <defs>
        ...
        <symbol id="s-kaninchen" viewBox="0 0 64 64">
          <path d="M32 20c4.6 0 8.4 3.4 8.4 8.2 0 2.2-.9 4.2-2.3 5.7 3.9.9 6.6 3.8 6.6 7.3 0 4.8-5.6 8.2-12.7 8.2s-12.7-3.4-12.7-8.2c0-3.4 2.5-6.2 6.4-7.2-1.4-1.5-2.2-3.5-2.2-5.8 0-4.8 3.8-8.2 8.5-8.2z" />
          <path d="M27 19c-1.9-3.4-2.2-7.2-1-10.8 2.6 3.4 3.8 7.4 3 10.8z" />
          <path d="M37 19c1.9-3.4 2.2-7.2 1-10.8-2.6 3.4-3.8 7.4-3 10.8z" />
        </symbol>
        <symbol id="s-schnepfe" viewBox="0 0 64 64">
          <path d="M40 20c6.4 0 11 4.6 11 10.8 0 6.2-4.6 10.8-11 10.8-3.6 0-6.8-1.7-8.8-4.4-2.6.6-5.2.4-7.6-.8-2.2-1.2-4-3-5.2-5.2-1.4-2.6-1.6-5.7-.5-8.4C20 19.6 23.2 17.4 27 17.2c2.2-.1 4.3.5 6.2 1.7C35 17.6 37.4 20 40 20z" />
          <path d="M15 27 2.4 33.2 17 28.2z" />
          <circle cx="25" cy="25.5" r="1.6" fill="#fff" opacity=".5" />
        </symbol>
      </defs>
    </svg>
  );
